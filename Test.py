...
heading = Label(root, text="File manipulation", height=5, width=100, font=("arial", 20, "bold"), relief="raised",border=2, bg="black", fg="white").pack()


frame = Frame(root, bg="black")
frame.pack()

label1 = Label(frame, text="Enter file path \n with file name", width=50, border=3, fg="white", bg="black").pack(side=LEFT)

inputtext = Entry(frame, textvariable="input file path", width=55, font=("arial", 20, "italic"), bg="white",fg="black")
...
inputtext1 = Entry(frame1, textvariable="input file1 path", width=55,font=("arial", 20, "italic"), bg="yellow",fg="black")
...
show = Button(bottomframe, text="show file content", fg="white", bg="green",command=func_show,height=3).pack(side=LEFT)
replacetext = Button(bottomframe, text="replace text", fg="white", bg="purple",height=3,command=func_replace).pack(side=LEFT)
deleteFile=Button(bottomframe, text="delete file", fg="white", bg="red",height=3,command=func_delete).pack(side=LEFT)
createFile =Button(bottomframe, text="create file", fg="black", bg="yellow",height=3,command=func_create).pack(side=LEFT)
deletedata=Button(bottomframe, text="delete data", fg="white", bg="brown",height=3,command=func_delete_data).pack(side=LEFT)
appendcontent=Button(bottomframe, text="append content", fg="white", bg="black",height=3,command=func_append_content).pack(side=LEFT)
appendfile= Button(bottomframe, text="apppend file", fg="black", bg="white",height=3,command=func_append_file).pack()
root.mainloop()
